...
export default function Socials() {
  return (
    <div className={styles.container}>
      <a href="https://github.com/" target="_blank" rel="noreferrer" aria-label="GitHub" className={styles.item}>
      ...
      <a href="https://twitter.com/" target="_blank" rel="noreferrer" aria-label="Twitter" className={styles.item}>
      ...
      <a href="mailto:you@example.com" aria-label="Email" className={styles.item}>
